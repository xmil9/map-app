...
public class LineRay2DTest {

	@Test
	public void construct_FromPointAndVector() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line = new LineRay2D(start, new Vector2D(-1, 3));
	...
	public void equals_WhenEqual() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line1 = new LineRay2D(start, new Vector2D(-1, 3));
		LineRay2D line2 = new LineRay2D(start, new Vector2D(-1, 3));
	...
	public void equals_WhenInequal() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line1 = new LineRay2D(start, new Vector2D(-1, 3));
		LineRay2D line2 = new LineRay2D(new Point2D(1, 2), new Vector2D(-3, 4));
	...
	public void copy() {
		...
		LineRay2D l = new LineRay2D(pt, new Vector2D(1, 1));
		Line2D copy = l.copy();
	...
	public void isPoint() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line = new LineRay2D(start, new Vector2D(1, 2));
	...
	public void isPoint_ForDegenerateLine() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line = new LineRay2D(start, new Vector2D());
	...
	public void anchorPoint() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line = new LineRay2D(start, new Vector2D(1, 0));
	...
	public void hasEndPoint() {
		...
		LineRay2D line = new LineRay2D(anchor, new Vector2D(1, 0));
	...
	public void direction() {
		Point2D start = new Point2D(3, 4);
		LineRay2D line = new LineRay2D(start, new Vector2D(2, 0));
	...
	public void isPointOnLine_WhenPointIsOnLine() {
		...
		LineRay2D line = new LineRay2D(start, dir);
	...
	public void isParallel_ForParallelLine() {
		Vector2D dir = new Vector2D(2, 1);
		LineRay2D line1 = new LineRay2D(new Point2D(3, 4), dir);
		LineRay2D line2 = new LineRay2D(new Point2D(2, 1), dir);
	...
	public void isParallel_ForNonParallelLine() {
		LineRay2D line1 = new LineRay2D(new Point2D(3, 4), new Vector2D(2, 1));
		LineRay2D line2 = new LineRay2D(new Point2D(2, 1), new Vector2D(1, 3));
	...
	public void isCoincident_ForCoincidentLine() {
		Vector2D dir = new Vector2D(2, 1);
		LineRay2D line1 = new LineRay2D(new Point2D(3, 4), dir);
		LineRay2D line2 = new LineRay2D(new Point2D(5, 5), dir);
