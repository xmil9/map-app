...
public class PolygonLineIntersection2DTest {
	...
	public void convexPolygonLine_ForEmptyPoly() {
		...
		List<Polygon2D> res = PolygonLineIntersection2D.convexPolygonLine(p, l);
	...
	@Test
	public void convexPolygonLine_ForPolyWithSinglePoint() {
		InfiniteLine2D l = new InfiniteLine2D(new Point2D(1, 2), new Vector2D(2, 1)); 
		Polygon2D p = new Polygon2D();
	...
	@Test
	public void convexPolygonLine_ForPolyWithSinglePointOnLine() {
		InfiniteLine2D l = new InfiniteLine2D(new Point2D(1, 2), new Vector2D(2, 1)); 
		Polygon2D p = new Polygon2D();
	...
	@Test
	public void convexPolygonLine_ForPolyWithTwoPointsCrossingTheLine() {
		InfiniteLine2D l = new InfiniteLine2D(new Point2D(1, 2), new Vector2D(2, 1)); 
		Polygon2D p = new Polygon2D();
		p.addVertex(new Point2D(1, 1));
	...
	@Test
	public void convexPolygonLine_ForPolyWithTwoPointsOnSameSideOfLine() {
		InfiniteLine2D l = new InfiniteLine2D(new Point2D(1, 2), new Vector2D(2, 1)); 
		Polygon2D p = new Polygon2D();
	...
	@Test
	public void convexPolygonLine_ForPolyWithTwoPointsOnLine() {
		InfiniteLine2D l = new InfiniteLine2D(new Point2D(1, 2), new Vector2D(2, 1)); 
		Polygon2D p = new Polygon2D();
	...
	@Test
	public void convexPolygonLine_ForPolyIntersectedByLine() {
		InfiniteLine2D l = new InfiniteLine2D(new Point2D(1, 2), new Vector2D(2, 1)); 
		Polygon2D p = new Polygon2D();
		p.addVertex(new Point2D(1, -1));
	...
	@Test
	public void convexPolygonLine_ForPolyNotIntersectedByLine() {
	...
	@Test
	public void convexPolygonLine_ForPolyTouchedByLine() {
	...
	@Test
	public void convexPolygonLine_ForPolyIntersectedByLineWithAllButOnePointOnSameSide() {
